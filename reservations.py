...
class Reservation:
    ...
    def search_hanndle(self, *args):
        ...
        self.table = Frame(self.scrollable_frame, bg='white')
        self.table.pack()
        ...
        for i, row_data in enumerate(data_rows):
            ...
            edit_btn = Button(self.table, image=self.resized_edit_img, bg='white',
                              command=lambda r=row_data: self.edit_reservation_show(r))
            edit_btn.grid(row=row_index, column=6, sticky="w")
            remove_btn = Button(self.table, image=self.resized_remove_img, bg='white',
                                command=lambda r=row_data: self.remove_reservation(r))
